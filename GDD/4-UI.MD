...
-   **In-Game Navigation (`LocationNav.tsx`):** A persistent navigation bar provides access to the main game screens. It has two variants: `floating` for the `LocationScreen` and `solid` for other menu screens.
