...
const MainMenu: FC<MainMenuProps> = ({ onNewGame, onContinue, hasRecentSave, onOpenOptionsModal, onOpenSaveLoadModal }) => {
    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center p-8">
            ...
            <div className="mt-12 flex flex-col space-y-4 animate-fade-in-up delay-500">
                {hasRecentSave && <MenuButton onClick={onContinue}>Continue</MenuButton>}
                <MenuButton onClick={onNewGame}>New Game</MenuButton>
                <MenuButton onClick={onOpenSaveLoadModal}>Load Game</MenuButton>
                <MenuButton onClick={onOpenOptionsModal}>Settings</MenuButton>
