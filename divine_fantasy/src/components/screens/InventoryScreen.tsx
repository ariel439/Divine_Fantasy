                ...
                <header className="mb-6 flex-shrink-0">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 p-4 bg-black/20 rounded-lg border border-zinc-800">
                        ...
                        <div className="flex items-center gap-6 text-lg">
                            <div className="flex items-center gap-2" title="Gold"><Coins size={20} className="text-yellow-400" /> <span>12</span></div>
                            <div className="flex items-center gap-2" title="Silver"><Coins size={20} className="text-gray-400" /> <span>150</span></div>
                            <div className="flex items-center gap-2" title="Copper"><Coins size={20} className="text-orange-400" /> <span>80</span></div>
                        </div>
                    </div>
                </header>
